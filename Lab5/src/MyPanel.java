...
public class MyPanel extends JPanel {
	...
	public void placeBombs() {
		int genedBombs = 0;
		while (genedBombs < NUM_BOMBS) {
			int randXCoord = randomNum.nextInt(9);
			int randYCoord = randomNum.nextInt(9);
			if (bombPlacement[randXCoord][randYCoord] != true) {
				genedBombs++;
				bombPlacement[randXCoord][randYCoord] = true;
			}
		}
	}
